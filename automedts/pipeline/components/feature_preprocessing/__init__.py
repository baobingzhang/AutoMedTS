...
_preprocessors = find_components(
    __package__, classifier_directory, automedtsPreprocessingAlgorithm
)
...
def add_preprocessor(preprocessor: Type[automedtsPreprocessingAlgorithm]) -> None:
    additional_components.add_component(preprocessor)


class FeaturePreprocessorChoice(automedtsChoice):
    @classmethod
