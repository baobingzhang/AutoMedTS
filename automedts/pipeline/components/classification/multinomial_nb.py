...
from automedts.pipeline.constants import DENSE, PREDICTIONS, SIGNED_DATA, SPARSE
from automedts.util.common import check_for_bool


class MultinomialNB(automedtsClassificationAlgorithm):
