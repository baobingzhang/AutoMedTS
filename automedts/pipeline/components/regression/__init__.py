...
_regressors = find_components(
    __package__, regressor_directory, automedtsRegressionAlgorithm
)
additional_components = ThirdPartyComponents(automedtsRegressionAlgorithm)
_addons["regression"] = additional_components


def add_regressor(regressor: Type[automedtsRegressionAlgorithm]) -> None:
    additional_components.add_component(regressor)


class RegressorChoice(automedtsChoice):
    @classmethod
