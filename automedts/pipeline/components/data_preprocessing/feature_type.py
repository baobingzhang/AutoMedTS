...
from automedts.pipeline.base import (
...
from automedts.pipeline.components.base import (
    automedtsChoice,
    automedtsComponent,
    automedtsPreprocessingAlgorithm,
)
from automedts.pipeline.components.data_preprocessing.feature_type_categorical import (  # noqa : E501
    CategoricalPreprocessingPipeline,
)
from automedts.pipeline.components.data_preprocessing.feature_type_numerical import (
    NumericalPreprocessingPipeline,
)
from automedts.pipeline.components.data_preprocessing.feature_type_text import (
    TextPreprocessingPipeline,
)
from automedts.pipeline.constants import DENSE, INPUT, SPARSE, UNSIGNED_DATA


class FeatTypeSplit(automedtsPreprocessingAlgorithm):
    """
    ...
    def __init__(
        ...
        if self.feat_type is None:
            self._transformers: List[Tuple[str, automedtsComponent]] = [
    ...
    def set_hyperparameters(
        ...
        for transf_name, transf_op in self._transformers:
            ...
            if isinstance(
                transf_op, (automedtsChoice, automedtsComponent, BasePipeline)
            ):
