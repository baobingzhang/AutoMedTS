...
import automedts.pipeline.implementations.CategoryShift
...
class CategoryShift(automedtsPreprocessingAlgorithm):
    ...
    def fit(
        ...
        self.preprocessor = (
            automedts.pipeline.implementations.CategoryShift.CategoryShift()
        )
