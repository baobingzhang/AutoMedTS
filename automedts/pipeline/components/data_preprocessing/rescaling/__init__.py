...
_rescalers = find_components(
    __package__, rescaling_directory, automedtsPreprocessingAlgorithm
)
additional_components = ThirdPartyComponents(automedtsPreprocessingAlgorithm)
...
class RescalingChoice(automedtsChoice):
    @classmethod
