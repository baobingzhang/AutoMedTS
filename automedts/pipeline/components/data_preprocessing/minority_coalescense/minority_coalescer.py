...
import automedts.pipeline.implementations.MinorityCoalescer
...
class MinorityCoalescer(automedtsPreprocessingAlgorithm):
    ...
    def fit(
        ...
        self.preprocessor = (
            automedts.pipeline.implementations.MinorityCoalescer.MinorityCoalescer(
