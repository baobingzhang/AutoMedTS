...
from automedts.pipeline.components import (
    feature_preprocessing as feature_preprocessing_components,
)
from automedts.pipeline.components import regression as regression_components
...
class SimpleRegressionPipeline(RegressorMixin, BasePipeline):
    ...
    _estimator : The underlying scikit-learn regression model. This
        ...
        :meth:`automedts.pipeline.regression.SimpleRegressionPipeline.fit`
        method.
