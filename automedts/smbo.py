...
from automedts.metalearning.metafeatures.metafeatures import (
    calculate_all_metafeatures_encoded_labels,
    calculate_all_metafeatures_with_labels,
)
from automedts.metalearning.metalearning.meta_base import MetaBase
from automedts.metalearning.mismbo import suggest_via_metalearning
        ...
        if self.num_metalearning_cfgs > 0:
            ...
            if self.metadata_directory is None:
                metalearning_directory = os.path.dirname(
                    automedts.metalearning.__file__
                )
